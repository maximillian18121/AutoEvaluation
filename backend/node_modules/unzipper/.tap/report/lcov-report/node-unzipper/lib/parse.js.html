...
<head>
    <title>Code coverage report for node-unzipper/lib/parse.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">node-unzipper/lib</a> parse.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">94.48% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>274/290</span>
            </div>
...
<a name='L291'></a><a href='#L291'>291</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">28x</span>
...
<span class="branch-0 cbranch-no" title="branch not covered" >      self.emit('error',e);</span>
  });
}
&nbsp;
...
&nbsp;
      if (self._opts.verbose) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >        if (entry.type === 'Directory') {</span>
<span class="cstat-no" title="statement not covered" >          console.log('   creating:', fileName);</span>
<span class="cstat-no" title="statement not covered" >        } else if (entry.type === 'File') {</span>
<span class="cstat-no" title="statement not covered" >          if (vars.compressionMethod === 0) {</span>
<span class="cstat-no" title="statement not covered" >            console.log(' extracting:', fileName);</span>
<span class="cstat-no" title="statement not covered" >          } else {</span>
<span class="cstat-no" title="statement not covered" >            console.log('  inflating:', fileName);</span>
...
<span class="branch-0 cbranch-no" title="branch not covered" >          console.log({</span>
