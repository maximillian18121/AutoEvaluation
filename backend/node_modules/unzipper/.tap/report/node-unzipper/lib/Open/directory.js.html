...
<head>
    <title>Code coverage report for node-unzipper/lib/Open/directory.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">node-unzipper/lib/Open</a> directory.js</h1>
        <div class='clearfix'>
...
<a name='L231'></a><a href='#L231'>231</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">28x</span>
...
<span class="cline-any cline-yes">18x</span>
<span class="cline-any cline-yes">28x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var PullStream = require('../PullStream');
...
&nbsp;
  if (d64loc.signature != 0x07064b50) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('invalid zip64 end of central dir locator signature (0x07064b50): 0x' + d64loc.signature.toString(16));</span>
...
&nbsp;
  if (vars.signature != 0x06064b50) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('invalid zip64 end of central dir locator signature (0x06064b50): 0x0' + vars.signature.toString(16));</span>
<span class="cstat-no" title="statement not covered" >  }</span>
&nbsp;
  return vars
}
...
&nbsp;
      vars.extract = function(opts) {
        if (!opts || !opts.path) <span class="branch-0 cbranch-no" title="branch not covered" >throw new Error('PATH_MISSING');</span>
...
&nbsp;
            ...
            if (extractPath.indexOf(opts.path) != 0) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >              return;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
            var writer = opts.getWriter <span class="branch-0 cbranch-no" title="branch not covered" >? opts.getWriter({path: extractPath}) </span>:  Writer({ path: extractPath });
&nbsp;
          ...
          }, { concurrency: opts.concurrency &gt; 1 <span class="branch-0 cbranch-no" title="branch not covered" >? opts.concurrency </span>: 1 });
        });
      };
&nbsp;
