...
<head>
    <title>Code coverage report for node-unzipper/lib/parseExtraField.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">node-unzipper/lib</a> parseExtraField.js</h1>
        <div class='clearfix'>
...
<a name='L38'></a><a href='#L38'>38</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">28x</span>
...
<span class="cline-any cline-yes">247x</span>
<span class="cline-any cline-yes">28x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var parseBuffer = require('./parseBuffer');
&nbsp;
...
<span class="branch-0 cbranch-no" title="branch not covered" >    vars.offsetToLocalFileHeader= extra.offset;</span>
&nbsp;
  return extra;
};
&nbsp;</pre></td></tr></table></pre>
